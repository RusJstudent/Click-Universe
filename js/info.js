...
Shield increase your total hitpoints.`;
...
to fix:
1. destroy button on phone ("show my" only is visible);
2. pay attention on btc amount with first launch of the game (may be incorrect)
3. Background должен быть один на всех устройствах
// Запретить увеличение экрана на сенсоре (пофиксил, проверить)

made today:
1. shields
2. damage display (with small animation)
3. ship little animation

soon: 
1. better damage animation
2. sell option
3. autofarm option
4. warranks

probably (later):
1. rank name and damage quantity in profile
2. menu
3. quests
4. more ships
*/